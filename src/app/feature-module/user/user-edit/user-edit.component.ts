    ...
    this.activatedRoute.paramMap.subscribe((data: ParamMap) => {
      ...
      this.userService.findById(parseInt(id)).subscribe(next => {
        ...
        this.userForm = this.formBuilder.group({
          ...
          name: [this.user.name,
            [Validators.required, Validators.maxLength(40), Validators.minLength(6),
          ...
          birthday: [this.user.birthday,
            [Validators.required, checkDateOfBirth]],
          phoneNumber: [this.user.phoneNumber,
            [Validators.required, Validators.pattern('^(\\+?84|0)(3[2-9]|5[689]|7[0|6-9]|8[1-9]|9[0-9])[0-9]{7}$')]],
